...
Use `9BA_run_model.ipynb` for routine runs. Its settings cell contains only:

```python
RUN_MODE = "daily"             # "daily", "monthly", or "peak"
REFERENCE_DATE = "2025-07-11" # ignored for peak
```
